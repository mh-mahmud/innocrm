<div class="card-body">
    ...
    <div class="row">
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            ...
            {{ Form::text('title', isset($estimate->title) ? $estimate->title : null, ['class' => 'form-control', 'required','autocomplete' => 'off','autofocus','placeholder'=> __('messages.products.title')]) }}
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
        ...
        <div class="form-group col-lg-4 col-md-6 col-sm-12">
            ...
            <div class="input-group">
                ...
                {{ Form::text('estimate_date', null, ['class' => 'form-control datepicker', 'required', 'autocomplete' => 'off','placeholder'=> __('messages.estimate.estimate_date')]) }}
            </div>
        </div>
        <div class="form-group col-lg-4 col-md-6 col-sm-12">
            ...
            <div class="input-group">
                ...
                {{ Form::text('estimate_expiry_date', null, ['class' => 'form-control due-datepicker', 'autocomplete' => 'off','placeholder'=>__('messages.estimate.expiry_date')]) }}
            </div>
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
    ...
    <div class="row">
        <div class="form-group col-lg-12 col-md-12 col-sm-12 overflow-section">
            <table class="table table-responsive-sm table-responsive-md table-striped table-bordered">
                ...
                <tr>
                    <td><input type="text" name="item[]" class="form-control item-name" required placeholder="{{__('messages.estimate.item')}}"></td>
                    <td><textarea name="description[]" class="form-control item-description" placeholder="{{  __('messages.common.description') }}"></textarea></td>
                    <td><input type="text" name="quantity[]" class="form-control qty" required min="0" placeholder="{{  __('messages.estimate.qty')  }}"></td>
