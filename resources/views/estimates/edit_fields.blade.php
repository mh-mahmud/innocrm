    ...
    <div class="row">
        ...
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            ...
            <select id="estimateCurrencyId" data-show-content="true" class="form-control currency-select-box"
                ...
                <option value="0" disabled="true" {{ isset($estimate->currency) ? '' : 'selected' }}>{{__('messages.placeholder.select_currency')}}
                </option>
        ...
        <div class="form-group col-lg-12 col-md-12 col-sm-12 overflow-section">
            <table class="table table-responsive-sm table-responsive-md table-striped table-bordered" id="itemTable">
                ...
                @foreach($estimate->salesItems as $item)
                    <tr>
                        <td>
                            {{ Form::text('item[]',$item->item,['class' => 'form-control item-name','required','placeholder'=>__('messages.estimate.item')]) }}
                        </td>
                        ...
                        <td>
                            {{ Form::text('quantity[]',$item->quantity,['class' => 'form-control qty','required','min' => '0','placeholder'=>__('messages.estimate.qty')]) }}
                        </td>
                        <td>
