    ...
    <div class="row">
        ...
        @forelse($invoices as $invoice)
            <div class="col-12 col-md-6 col-xl-3 col-xlg-4">
                <div class="livewire-card card card-{{ \App\Models\Invoice::STATUS_COLOR[$invoice->payment_status] }} shadow mb-5 rounded hover-card card-height height-210">
                            ...
                            <a href="{{ url('admin/invoices', $invoice->id) }}"
                               class="d-flex flex-wrap text-decoration-none">
                                <h4 class="text-primary invoice-clients invoice_title pl-2">
                                    {{ Str::limit(html_entity_decode($invoice->title), 5, '...') }}
                                </h4>
                    ...
                    <div class="card-body d-flex justify-content-between pt-1 px-3">
                        <div class="d-table w-100">
                            ...
                            <span class="badge mt-mobile-2 text-uppercase status-{{ \Illuminate\Support\Str::slug(\App\Models\Invoice::PAYMENT_STATUS[($invoice->payment_status)]) }}">
