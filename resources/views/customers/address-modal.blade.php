                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="form-group col-sm-12 col-lg-12">
                            ...
                            {{ Form::select('country[1]',$country,null, ['id'=>'billingCountryId','class' => 'form-control','placeholder' => __('messages.placeholder.select_country')]) }}
                        </div>
                    ...
                    <div class="col-lg-6">
                                ...
                                <a id="copyBillingAddress"
                                   class="text-black-50 text-decoration-none copy-billing-address-label">
                                    <input type="checkbox" id="shippingAddressCheck"
                                           class="mr-1" disabled>{{__('messages.customer.copy_billing_address')}}</a>
                            </h6>
                        </div>
                        <br>
                        <div class="form-group col-sm-12 col-lg-12">
                        ...
                        <div class="form-group col-sm-12 col-lg-12">
                            {{ Form::label('country',__('messages.address.country').':') }}
                            {{ Form::select('country[2]',$country,(isset($customer->country) && $customer->country!=null)?$customer->country:null, ['id'=>'shippingCountryId','class' => 'form-control','placeholder' => __('messages.placeholder.select_country')]) }}
                        </div>
