    ...
    <div class="tab-pane fade show active" id="cForm" role="tabpanel" aria-labelledby="customerForm">
        <div class="row">
            <div class="form-group col-md-3 col-sm-12">
                ...
                <input type="text" name="customer_code" value="{{$customer->customer_code}}" class="form-control" id="customer_code" autocomplete="off" placeholder="{{__('messages.customer.customer_code')}}" autofocus required>
            </div>
            <div class="form-group col-md-6 col-sm-12">
                <label for="customer_name">{{__('messages.customer.customer_name').':'}}<span
                    class="required">*</span></label>
                <input type="text" name="customer_name" value="{{$customer->customer_name}}" class="form-control" id="customer_name" autocomplete="off" placeholder="{{__('messages.customer.customer_name')}}" required>
            </div>
            <div class="form-group col-md-3 col-sm-12">
                <label for="short_name">{{__('messages.customer.short_name').':'}}<span
                    class="required">*</span></label>
                <input type="text" name="short_name" value="{{$customer->short_name}}" class="form-control" id="short_name" autocomplete="off" placeholder="{{__('messages.customer.short_name')}}" required>
            </div>
            <div class="form-group col-md-3 col-sm-12">
                {{ Form::label('default_n',__('messages.customer.default_n').':') }}<br>
                <label class="custom-switch pl-0">
                    <input type="checkbox" name="default_n" value="1" class="custom-switch-input"  @if($customer->default_n==1) {{'checked'}} @endif>
            ...
            <div class="form-group col-md-3 col-sm-12">
                <label for="email">{{__('messages.customer.email').':'}}<span
                    class="required">*</span></label>
                <input type="email" name="email" value="{{$customer->email}}" class="form-control" id="email" autocomplete="off" placeholder="{{__('messages.customer.email')}}">
            </div>
            <div class="form-group col-md-3 col-sm-12">
                <label for="website">{{__('messages.customer.website').':'}}<span
                    class="required">*</span></label>
                <input type="text" name="website" value="{{$customer->website}}" class="form-control" id="website" autocomplete="off" placeholder="{{__('messages.customer.website')}}">
            </div>
            <div class="form-group col-md-3 col-sm-12">
                ...
                <div class="input-group">
                    <select class="select2" name="default_language" id="language" style="width:80% !important;">
                        ...
                        @foreach($data['languages'] as $key=>$value)
                            <option value="{{$key}}" @if($customer->default_language==$key) {{'selected'}} @endif>{{$value}}</option>
                        @endforeach
                    </select>
                    <div class="input-group-append ">
                        <div class="input-group-text plus-icon-height">
            ...
            <div class="form-group col-md-3 col-sm-12">
                ...
                <input type="text" name="street" value="{{$customer->street}}" class="form-control" id="street" autocomplete="off" placeholder="{{__('messages.customer.street')}}">
            </div>
            <div class="form-group col-md-3 col-sm-12">
                ...
                <div class="input-group">
                    ...
                    <select class="select2" name="city" id="cityId" style="width:80% !important;">
                        ...
                        @foreach($data['cities'] as $key=>$value)
                            <option value="{{$key}}" @if($customer->city==$key) {{'selected'}} @endif>{{$value}}</option>
                        @endforeach
                    </select>
                    <div class="input-group-append ">
                        <div class="input-group-text plus-icon-height">
            ...
            <div class="form-group col-md-3 col-sm-12">
                ...
                <input type="text" name="zip" value="{{$customer->zip}}" class="form-control" id="zip" autocomplete="off" placeholder="{{__('messages.customer.zip')}}">
            </div>
            <div class="form-group col-md-3 col-sm-12">
                ...
                <div class="input-group">
                    <select class="select2" name="state" id="stateId" style="width:80% !important;">
                        ...
                        @foreach($data['states'] as $key=>$value)
                            <option value="{{$key}}" @if($customer->state==$key) {{'selected'}} @endif>{{$value}}</option>
                        @endforeach
                    </select>
                    <div class="input-group-append ">
                        <div class="input-group-text plus-icon-height">
            ...
            <div class="form-group col-md-3 col-sm-12">
                ...
                <select class="custom-select select2" name="country" id="countryId">
                    ...
                    @foreach($data['countries'] as $key=>$value)
                        <option value="{{$key}}" @if($customer->country==$key) {{'selected'}} @endif>{{$value}}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group col-md-3 col-sm-12">
                <label for="vat_number">{{__('messages.customer.vat_number').':'}}</label>
                <input type="text" name="vat_number" value="{{$customer->vat_number}}" minlength="4" maxlength="15" class="form-control" id="vat_number" autocomplete="off" placeholder="{{__('messages.customer.vat_number')}}">
            </div>
            <div class="form-group col-md-3 col-sm-12">
                <label for="credit_limit">{{__('messages.customer.credit_limit').':'}}</label>
                <input type="text" name="credit_limit" value="{{$customer->credit_limit}}" class="form-control" id="credit_limit" autocomplete="off" placeholder="{{__('messages.customer.credit_limit')}}">
            </div>
            <div class="form-group col-md-3 col-sm-12">
                <label for="previous_dues">{{__('messages.customer.previous_dues').':'}}</label>
                <input type="text" name="previous_dues" value="{{$customer->previous_dues}}" class="form-control" id="previous_dues" autocomplete="off" placeholder="{{__('messages.customer.previous_dues')}}">
            </div>
            ...
            <div class="form-group col-md-3 col-sm-12">
                ...
                <input type="text" name="location_link" value="{{$customer->location_link}}" class="form-control" id="location" autocomplete="off" placeholder="{{__('messages.customer.location')}}">
           </div>
            <div class="form-group col-md-3 col-sm-12">
                {{ Form::label('is_supplier',__('messages.customer.is_supplier').':') }}<br>
                <label class="custom-switch pl-0">
                    <input type="checkbox" name="is_supplier" value="1" class="custom-switch-input" @if($customer->is_supplier==1) {{'checked'}} @endif>
                    <span class="custom-switch-indicator"></span>
                </label>
            </div>
        </div>
