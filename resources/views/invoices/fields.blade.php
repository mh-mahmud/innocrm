<div class="card-body">
    ...
    <div class="row">
        <div class="form-group col-lg-4 col-md-6 col-sm-12">
            ...
            {{ Form::text('title', isset($invoice->title) ? $invoice->title : null, ['class' => 'form-control', 'required','autocomplete' => 'off','autofocus','placeholder'=> __('messages.products.title')]) }}
        </div>
        <div class="form-group col-lg-4 col-md-6 col-sm-12">
        ...
        <div class="form-group col-lg-12 col-md-12 col-sm-12 overflow-section">
            <table class="table table-responsive-sm table-responsive-md table-striped table-bordered">
                ...
                <tr>
                    ...
                    <th class="small-column">{{ __('messages.products.rate') }}(<i data-set-currency-class="true"></i>)
                ...
                <tr>
                    <td><input type="text" name="item[]" id="item" class="form-control item-name" required placeholder="{{ __('messages.invoice.item')  }}"></td>
                    <td><textarea name="description[]" class="form-control item-description" placeholder="{{ __('messages.common.description') }}"></textarea></td>
                    <td><input type="text" name="quantity[]" id="quantity" class="form-control qty" required min="0" placeholder="{{ __('messages.invoice.qty') }}">
                    </td>
                    <td><input type="text" name="rate[]" id="rate" class="form-control rate" required placeholder="{{ __('messages.products.rate') }}"></td>
                    <td class="">
