            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-12">
                        {{ Form::label('default_language',__('messages.user.language') .':') }}
                            <span class="required">*</span>
                        {{ Form::select('default_language',getLanguages(),getLoggedInUser()->default_language,['id' => 'defaultLanguage', 'class' => 'form-control','required']) }}
                    </div>
                </div>
